...
`toolstack.md` is a different aggregate format (emoji sections,
`* [**Name**](url) – desc **Pricing**` bullets) — only touch it when the user
asks about that list, and match its own style there.
